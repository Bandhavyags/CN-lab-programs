...
$ns duplex-link $n3 $n4 1Mb 20ms DropTail $ns duplex-link $n3 $n5 1Mb 20ms DropTail 
...
proc finish {} { 
 	global ns tr nam   	$ns flush-trace  	close $nam   	close $tr   	exec nam p9.nam &  	exit 0 
} 
